            ...
            <header class="header">
                <div class="box_header">
                    ...
                    <nav>
                        ...
                        <!-- Lien pour etre -->
                        <ul>
                            <li class="to_be"><a href="infographe/inscription_infographiste.php"  class=" primary_style">Devenir infographiste
                                </a></li>
                            <li class="to_be"><a href="<?php echo $_SESSION['user_type'] == "annonceur" ? "annonceur/dashboard.php" : "connexion.php"; ?>" >Publier une annonce </a></li>
                        </ul>
                    </nav>
                    ...
                    <div class="user-menu-container">
                        ...
                        ?>
                        <a href="<?php echo $_SESSION['user_type'] == "annonceur" ? "annonceur/dashboard.php" : "infographe/dashboard.php" ; ?>">
