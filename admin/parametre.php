                        ...
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="color" class="form-control form-control-color" id="primaryColor"
                                        name="primaryColor" value="#007bff">
                                </div>
                            ...
                            <form>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="headerTitle"
                                        placeholder="Titre de l'en-tête" value="Jemo Center">
                                </div>
                                <div class="mb-3">
                            ...
                            <form>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="footerText"
                                        rows="3">© 2024 Jemo. Tous droits réservés.</textarea>
                                </div>
