...
include 'database/fetch_administrateur.php';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Administrateurs - Jemo Dashboard</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="row h-100">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 d-flex flex-column">
                    <div
                        ...
                        <h1 class="h2">Administrateurs</h1>
                    </div>

                    <!-- Table or List of Administrateurs -->
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <!-- First Administrateur -->
                                     <?php
                                        foreach ($listDesAdminitrateur as $afficher) {
                                            # code...
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="../media/public/images/photos_membres/ppp.png"
                                                    alt="Michel Amani" class="rounded-circle" width="40" height="40"
                                                    class="me-3">
                                                <div class="ms-2">
                                                    <strong><?= $afficher['nom_administrateur'] ?></strong><br>
                                                    <span class="text-muted"><?= $afficher['username_administrateur'] ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="../media/public/images/photos_membres/ppp.png"
                                                    ...
                                                    class="me-3">
                                                <div class="ms-2">
                                                    <strong>Michel amani</strong><br>
                                                    <span class="text-muted">Administrateur principale</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>10/08/2024</td>
