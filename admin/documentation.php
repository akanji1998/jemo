                    ...
                    <div class="card mb-4 flex-grow-1">
                        <div class="card-body">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in venenatis enim.
                                Vivamus pulvinar imperdiet tortor, a auctor lectus volutpat non.</p>

                            <h3>Using the Dashboard</h3>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse quis elit neque.
                                Cras at massa a velit venenatis bibendum.
                                Phasellus gravida velit ac felis ullamcorper, at tincidunt justo dapibus. Fusce id
                                libero in turpis convallis malesuada ut nec lacus.
                            </p>
                            <ul>
                                <li><strong>Dashboard Overview</strong>: Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Nam dictum dolor eu lorem fermentum scelerisque.</li>
                                <li><strong>Accessing User Information</strong>: Proin finibus, erat et ullamcorper
                                    pharetra, libero lorem gravida lectus, vitae lacinia justo mauris ut eros.</li>
                                <li><strong>Working with Data</strong>: Aenean varius feugiat risus, vel tincidunt arcu.
                                    Integer tincidunt interdum tellus a pretium.</li>
                            </ul>

                            <h3>Managing Infographistes</h3>
                            <p>
                                Nulla facilisi. In hac habitasse platea dictumst. Curabitur sollicitudin auctor purus,
                                sed bibendum orci vestibulum in. Vivamus consequat pharetra turpis.
                            </p>

                            <h3>Managing Annonceurs</h3>
                            <p>
                                Fusce quis massa tortor. Cras euismod mauris ut eros placerat, sit amet malesuada sapien
                                convallis. Quisque nec efficitur felis.
                            </p>

                            <h3>Managing Administrators</h3>
                            <p>
                                Phasellus scelerisque ex lorem, at ultrices sem dapibus sit amet. Vestibulum vestibulum
                                ligula euismod diam vulputate, sit amet vulputate velit vehicula.
                            </p>

                            <h3>Technical Support</h3>
                            <p>
                                Vivamus vehicula magna sit amet dui hendrerit, ac viverra elit tristique. Quisque
                                volutpat erat id nulla molestie, ut vehicula arcu vehicula.
                            ...
                            <p>
                                ...
                                A: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce mollis accumsan
                                vehicula.
                            </p>
                            <p>
                                <strong>Q: How can I contact support?</strong><br>
                                A: Suspendisse potenti. Curabitur sed dignissim lectus. Cras ut mi nec ante suscipit
                                malesuada.
                            </p>
                        </div>
                    </div>
