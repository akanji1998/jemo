...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO annonceur (nom_annonceur, prenom_annonceur, domaine_activite_annonceur, telephone_annonceur, email_annonceur, date_naissance_annonceur, username_annonceur, photo_annonceur,date_inscription_annonceur, mdp_annonceur)
            VALUES (:nom, :prenom, :entreprise, :telephone, :email, :date_naissance, :username, :photo,:date_inscription, :mdp)";
